...
const js = ['theme.js', 'app.js', 'api.js', 'ui.js', 'state.js', 'outbox.js', 'capture.js', 'views/common.js', 'views/today.js', 'views/inbox.js', 'views/item.js', 'views/chat.js', 'views/search.js', 'views/more.js', 'views/dreams.js', 'views/journal.js', 'views/beta.js', 'views/link.js'];
