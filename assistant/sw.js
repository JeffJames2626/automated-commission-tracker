...
const VERSION = 'asst-v4';
const SHELL = [
  './', 'index.html', 'theme.js', 'app.css', 'app.js', 'api.js', 'ui.js', 'state.js', 'outbox.js', 'capture.js',
  'views/common.js', 'views/today.js', 'views/inbox.js', 'views/item.js', 'views/chat.js', 'views/search.js', 'views/more.js', 'views/dreams.js', 'views/journal.js',
