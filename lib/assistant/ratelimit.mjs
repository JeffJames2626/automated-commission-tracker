...
export const LIMITS = {
  ...
  // "Connect Personal Assistant" from the app: starting a link (per caller),
  // waiting for the owner to approve it (per link, and a ceiling per caller).
  link: { perMinute: 10, perDay: 100 },
  linkpoll: { perMinute: 40, perDay: 1000 },
  linkpollip: { perMinute: 120, perDay: 20000 },
  feedback: { perMinute: 6, perDay: 100 },
  export: { perMinute: 2, perDay: 20 },
};
