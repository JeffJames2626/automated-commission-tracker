...
export async function answer({ db, user, claude, google, conversationId, question, tz, now = Date.now(), emit = () => {}, journalId = null, journalDone = [] }) {
  ...
  const ctx = { db, userId: user.id, user, tz, now, google, conversationId, actions: [], created: [], journalId, ownerText: question };
